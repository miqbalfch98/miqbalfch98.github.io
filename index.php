...
<html lang="id">
  ...
  <body>
      ...
      <div class="container ">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="?m=peta"><span class="glyphicon glyphicon-lock"></span> Peta Kabupaten Pekalonngan</a></li>
    ...
    <footer class="footer bg-success">
      <div class="container">
        <p>Copyright &copy; <?=date('Y')?> Sistem Informasi Geografis Pariwisata Pekalongan|  by <a href='https://stokcoding.com/' style="color: red;" title='StokCoding.com' target='_blank'>19670097</a>
         <em class="pull-right">MiqbalFachrezi 2022</em></p>
      </div>
    </footer>
